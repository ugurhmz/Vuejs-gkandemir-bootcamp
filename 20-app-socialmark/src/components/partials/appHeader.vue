                ...
                <div class="relative group">
                    ...
                    <nav class="bg-white !z-10 rounded-md shadow-md p-2 w-56 flex flex-col absolute group-focus-within:visible top-full right-0 invisible">
                      ...
                      <router-link class="mb-2 menu-item" :to="{ name : 'Likes' }"  >
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-current  mr-1"
...
export default  {
    ...
    methods : {
      onLogout() {
         this.$store.commit("logoutUser") // store->index.js içindeki mutationsa logoutUser adlı funcu yolluyoruz.
