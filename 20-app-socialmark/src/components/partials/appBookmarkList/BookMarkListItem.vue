            ...
            <div class="flex items-center justify-center mt-2 gap-x-1">
                ...
                <div class="relative group">
                    <button class="details-btn !-z-[1] group">
                        ...
                        <p class="details-container">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                            Similique nemo consequatur a accusamus assumenda laborum consequuntur explicabo
                            dolor, odit eligendi voluptate illum itaque accusantium, cumque tenetur cupiditate
                            illo libero dolores!</p>
                    </button>
                </div>
            </div>
